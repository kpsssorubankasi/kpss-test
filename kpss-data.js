const kpssData = {
  ...
  {
    soru: "“Bu kitabı anlamak için yalnızca okumak yetmez, aynı zamanda düşünmek gerekir.” cümlesinden aşağıdakilerden hangisi çıkarılabilir?",
    siklar: [
  ...
  {
    soru: "“O, yalnızca çalışkan değil, aynı zamanda son derece disiplinli bir öğrencidir.” cümlesi ile aşağıdakilerden hangisi anlamca en yakındır?",
    siklar: [
  ...
  {
    soru: "“Onun sözleri oldukça ağırdı.” cümlesinde “ağır” sözcüğü aşağıdaki anlamlardan hangisinde kullanılmıştır?",
    siklar: [
  ...
  {
    soru: "Beş kişi (A, B, C, D, E) bir sıraya dizilecektir. A, B’nin hemen önünde; C, D’nin hemen arkasında olacaktır. E ise en başta olmayacaktır. Buna göre aşağıdakilerden hangisi kesinlikle doğrudur?",
    siklar: [
      "A en baştadır",
      "B en sondadır",
      "C, D’den sonra gelir",
